...
export default function Preloader({ skip = false }: PreloaderProps) {
    ...
    useEffect(() => {
        ...
        const windowWithSkip = window as Window & { __preloaderSkip?: () => void };
        windowWithSkip.__preloaderSkip = finish;
        ...
        return () => {
            ...
            document.body.style.overflow = prevOverflow;
            delete windowWithSkip.__preloaderSkip;
        };
    }, [skip]);
    ...
    return (
        <div className={`${styles.preloader} ${fade ? styles.fadeOut : ''}`}>
            <button className={styles.skipBtn} onClick={handleSkip} aria-label="Skip intro" type="button">
                Skip →
            </button>
            ...
            <div className={styles.quickLinks}>
                ...
                <button className={styles.quickLink} type="button" onClick={() => setIsDonationModalOpen(true)}>
                    Donate
                </button>
                <span className={styles.quickLinkDivider} />
