        ...
        try {
            const res = await fetch('/api/contact', {
                ...
                body: JSON.stringify({ 
                    ...
                    name: form.name,
                    email: form.email,
                    message: `Platform/Reach: ${form.platform}\n\nAdvocacy Interest:\n${form.message}`
                }),
            });
        ...
        <div className={styles.container}>
            <div className={styles.header}>
                ...
                <p className={styles.subtitle}>
                    Amplify our message that every girl deserves to rise. Use your voice, platform, and networks to spread awareness.
                </p>
            </div>
                ...
                <div className={styles.infoSection}>
                    ...
                    <div className={styles.opportunityList}>
                        <div className={styles.opportunityCard}>
                            <h3>📢 Social Media Ambassador</h3>
                            <p>Share our stories, campaigns, and impact updates on your social channels.</p>
                        </div>
                        <div className={styles.opportunityCard}>
                            <h3>✍️ Content Creator</h3>
                            <p>Write blog posts, create videos, or produce podcasts highlighting our mission.</p>
                        </div>
                        <div className={styles.opportunityCard}>
                            <h3>🎤 Community Speaker</h3>
                            <p>Present about our work at schools, churches, conferences, and community events.</p>
                        </div>
                        <div className={styles.opportunityCard}>
                            <h3>📸 Storyteller</h3>
                        ...
                        <form className={styles.form} onSubmit={handleSubmit}>
                            ...
                            <div className={styles.formGroup}>
                                ...
                                <input
                                    ...
                                    className={styles.input}
                                    placeholder="e.g., Instagram (5K followers), Church community leader, Blogger..."
                                />
                            </div>
                            <div className={styles.formGroup}>
                                <label htmlFor="message">How would you like to advocate for us? *</label>
                                <textarea
                                    id="message"
                                    value={form.message}
                                    ...
                                    placeholder="Share your ideas for spreading our message..."
                                />
                            </div>
                            {status === 'success' && (
                            ...
                            >
                                {status === 'loading' ? 'Sending...' : 'Become an Advocate'}
                            </button>
                        </form>
                    </div>
                </div>
