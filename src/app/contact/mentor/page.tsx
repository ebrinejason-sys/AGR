        ...
        <div className={styles.container}>
            <div className={styles.header}>
                ...
                <p className={styles.subtitle}>
                    Share your time, wisdom, and expertise to guide rising leaders toward their full potential.
                </p>
            </div>
                ...
                <div className={styles.infoSection}>
                    ...
                    <div className={styles.opportunityList}>
                        <div className={styles.opportunityCard}>
                            ...
                            <p>Guide girls through career exploration, university applications, and professional development.</p>
                        </div>
                        <div className={styles.opportunityCard}>
                            <h3>📚 Academic Support</h3>
                            <p>Tutoring, homework help, STEM workshops, and exam preparation.</p>
                        </div>
                        <div className={styles.opportunityCard}>
                            <h3>💼 Skills Training</h3>
                            <p>Teach digital skills, financial literacy, public speaking, or entrepreneurship basics.</p>
                        </div>
                        <div className={styles.opportunityCard}>
                            <h3>🌟 Rise Sisterhood</h3>
                            <p>Join our Big Sister/Little Sister program to provide ongoing encouragement and guidance.</p>
                        </div>
                    </div>
                </div>
                        ...
                        <form className={styles.form} onSubmit={handleSubmit}>
                            ...
                            <div className={styles.formGroup}>
                                ...
                                <input
                                    ...
                                    required
                                    className={styles.input}
                                    placeholder="e.g., Weekends, Once a month, Virtual only..."
                                />
                            </div>
                            <div className={styles.formGroup}>
                                ...
                                <textarea
                                    ...
                                    placeholder="Share what motivates you to get involved..."
                                />
                            </div>
                            {status === 'success' && (
                            ...
                            >
                                {status === 'loading' ? 'Sending...' : 'Join as a Mentor'}
                            </button>
                        </form>
                    </div>
                </div>
