...
export const metadata: Metadata = {
  title: "Privacy Policy | African Girl Rise",
  description:
    "Learn how African Girl Rise collects, uses, and protects your personal information.",
};
    ...
    <div className={styles.page}>
      <div className={styles.container}>
        ...
        <div className={styles.body}>
          ...
          <ul>
            <li>
              <strong>Email address</strong> — when you subscribe to our newsletter or submit a
              contact form.
            </li>
            <li>
              <strong>Name and message</strong> — when you use our contact or partnership enquiry
              forms.
            </li>
            <li>
          ...
          <ul>
            <li>
              <strong>Usage data</strong> — pages visited, browser type, device type, and
              approximate geographic region, collected via server logs and analytics.
            </li>
            <li>
              <strong>Cookies</strong> — we use only essential cookies required for the Site to
              function (e.g., session management). We do not use advertising or tracking cookies.
            </li>
          </ul>
          ...
          <ul>
            <li>
              <strong>Supabase</strong> — database hosting for subscriber and contact data
              (hosted in data centres with industry-standard security).
            </li>
            <li>
              <strong>Resend</strong> — transactional email delivery for contact confirmations
              and newsletters.
            </li>
            <li>
          ...
          <p>
            Each provider is bound by its own privacy policy and applicable data protection law.
            We do not permit any provider to use your data for their own marketing purposes.
          </p>
          ...
          <ul>
            ...
            <li>
              <strong>Contact enquiries</strong> — up to 2 years after the enquiry is resolved.
            </li>
            <li>
              <strong>Donation records</strong> — up to 7 years to comply with financial
          ...
          <ul>
            ...
            <li>
              <strong>Delete</strong> your data (subject to legal retention requirements);
            </li>
            <li>
              <strong>Withdraw consent</strong> for email communications at any time by clicking
              the unsubscribe link in any email or contacting us directly;
            </li>
            <li>
              <strong>Object</strong> to or restrict certain uses of your data.
            </li>
          </ul>
          <p>
          ...
          <p>
            ...
            against unauthorised access, disclosure, alteration, or destruction. All data
            transmitted to and from the Site is encrypted via HTTPS/TLS.
          </p>
          ...
          <p>
            Our service providers may process data outside Uganda. Where this occurs, we ensure
