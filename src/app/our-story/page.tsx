        ...
        <div className={styles.container}>
                    ...
                    <div className={styles.premiumNarrative}>
                        ...
                        <div className={styles.missionVision}>
                            <div className={styles.challengeCard}>
                                ...
                                <p className={styles.challengeText}>Untreated trauma, anxiety, and depression become walls around potential. 78% of girls in local schools report persistent anxiety, with trauma from poverty and instability manifesting as academic disengagement.</p>
                            </div>
                            <div className={`${styles.challengeCard} ${styles.challengeCardPurple}`}>
                                <p className="subheading">Challenge 02</p>
                                <h3>An Educational Emergency</h3>
                                <p className={styles.challengeText}>4 in 10 girls drop out before Form 4, primarily due to economic pressure, early pregnancy, or loss of hope in education&apos;s value. School dropouts and academic failure cut the rope before they can climb.</p>
                            </div>
                            <div className={`${styles.challengeCard} ${styles.challengeCardBlue}`}>
                                <p className="subheading">Challenge 03</p>
                                <h3>A Cycle of Disempowerment</h3>
                                <p className={styles.challengeText}>Early pregnancies and societal limitations tell girls their stories are already written. We reject this narrative. A girl&apos;s toughest ground can become the foundation for her greatest strength.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className={styles.narrativeWrapper}>
                    <div className={styles.storyGrid}>
                        <div>
                            ...
                            <p className={styles.bodyCopyLarge}>
                            ...
                            <p className={`${styles.bodyCopyLarge} ${styles.bodyCopyTight}`}>
                    ...
                    <div className={styles.coreBeliefPanel}>
                        ...
                        <h2 className={`${styles.coreBeliefHeading} heading-section`}>
                        ...
                        <p className={styles.coreBeliefQuote}>
            ...
            <section className={styles.founderVision}>
                <div className={styles.founderVisionInner}>
                    ...
                    <Link href="/founder" className={`btn-premium ${styles.founderVisionButton}`}>
